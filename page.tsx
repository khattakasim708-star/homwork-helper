...
// Clean, modern color palette with enhanced SVG icons
const SUBJECTS = [
  { 
    id: "urdu", 
    name: "Urdu", 
  ...
  { 
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className="w-12 h-12">
        ...
        <circle cx="50" cy="50" r="35" fill="url(#mathGradient)" />
        <path fill="white" d="M40 35h20v5h-20v-5zm0 10h20v5h-20v-5zm0 10h20v5h-20v-5z" />
        <path fill="white" d="M50 30l-5 10h10l-5-10z" />
      </svg>
    )
  },
  { 
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className="w-12 h-12">
        ...
        <circle cx="50" cy="50" r="35" fill="url(#physicsGradient)" />
        <path fill="white" d="M50 30c-11 0-20 9-20 20s9 20 20 20 20-9 20-20-9-20-20-20zm0 30c-5.5 0-10-4.5-10-10s4.5-10 10-10 10 4.5 10 10-4.5 10-10 10z" />
        <circle cx="50" cy="50" r="5" fill="white" />
        <path fill="white" d="M30 50h5v5h-5v-5zm40 0h5v5h-5v-5z" />
      </svg>
    )
  },
  { 
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className="w-12 h-12">
        ...
        <circle cx="50" cy="50" r="35" fill="url(#chemistryGradient)" />
        <path fill="white" d="M45 30h10v40h-10v-40z" />
        <path fill="white" d="M35 45h30v10h-30v-10z" />
  ...
  { 
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" className="w-12 h-12">
        <defs>
          <linearGradient id="biologyGradient" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#22c55e" />
            <stop offset="100%" stopColor="#059669" />
          </linearGradient>
        </defs>
        <circle cx="50" cy="50" r="35" fill="url(#biologyGradient)" />
        <path fill="white" d="M50 30c-11 0-20 9-20 20s9 20 20 20 20-9 20-20-9-20-20-20zm0 30c-5.5 0-10-4.5-10-10s4.5-10 10-10 10 4.5 10 10-4.5 10-10 10z" />
        <path fill="white" d="M45 45h10v10h-10v-10z" />
      </svg>
    )
  },
];
...
const SUBJECT_PROMPTS: Record<string, any> = {
  homework: {
    urdu: "You are a helpful Urdu language tutor. Answer in Urdu script with brief, clear explanations. Keep answers under 3 sentences.",
    english: "You are a helpful English tutor. Provide concise explanations in English. Keep answers under 3 sentences.",
    math: "You are a math tutor. Give brief, step-by-step solutions. Keep answers under 4 steps.",
    physics: "You are a physics tutor. Explain concepts simply and concisely. Keep answers under 3 sentences.",
    chemistry: "You are a chemistry tutor. Provide clear, brief explanations. Keep answers under 3 sentences.",
    biology: "You are a biology tutor. Explain briefly with key points. Keep answers under 3 sentences.",
  },
  exam: {
    urdu: "You are an exam tutor. Provide concise, exam-focused answers in Urdu script. Keep answers under 2 sentences.",
    english: "You are an exam tutor. Provide concise, exam-focused answers in English. Keep answers under 2 sentences.",
    math: "You are an exam tutor. Give brief, step-by-step solutions. Keep answers under 3 steps.",
    physics: "You are an exam tutor. Explain concepts simply and concisely. Keep answers under 2 sentences.",
    chemistry: "You are an exam tutor. Provide clear, brief explanations. Keep answers under 2 sentences.",
    biology: "You are an exam tutor. Explain briefly with key points. Keep answers under 2 sentences.",
  }
};
...
export default function HomeworkHelper() {
  ...
  const handleSubmit = async () => {
    if (!selectedSubject || !question.trim()) {
      setError("Please select a subject and enter a question");
      return;
    }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 p-4 md:p-6">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-2">
              <Button
                variant={mode === "homework" ? "default" : "outline"}
                size="sm"
                ...
                >
                  <CardContent className="p-4 flex flex-col items-center">
                    <motion.div
                      ...
                      transition={{ duration: 0.5, repeat: hoveredSubject === subject.id ? Infinity : 0 }}
          ...
          <Card className="bg-white border border-gray-200 shadow-sm">
            ...
            <CardContent>
              <Textarea
                ...
                placeholder={`Enter your ${mode} question here...`}
                className="min-h-[120px] resize-none border-gray-200 focus:ring-1 focus:ring-indigo-500 text-gray-700"
                maxLength={500}
              />
            </CardContent>
          </Card>
        ...
        >
          ...
          >
            {isLoading ? (
              ...
              <div className="flex items-center">
                ...
                Get {mode === "exam" ? "Exam-Focused" : "Homework"} Answer
              </div>
            )}
          </Button>
          ...
          {error && (
            <Button 
              variant="outline" 
              onClick={handleRetry}
              className="flex items-center border-indigo-300 text-indigo-700 hover:bg-indigo-50"
            >
                  ...
                  <div className="flex justify-between items-center">
                    <CardTitle className="flex items-center gap-2 text-gray-800">
                      ...
                      <span className="text-xs bg-indigo-100 text-indigo-800 px-2 py-0.5 rounded-full">
                        {mode === "exam" ? "Exam-Focused" : "Homework"}
                      </span>
                    </CardTitle>
                    <Button 
                      variant="outline" 
        ...
        <motion.footer
          ...
          className="text-center text-gray-500 text-sm mt-12 pt-6 border-t border-gray-200"
        >
          <motion.div
          ...
          >
            <div className="flex items-center gap-1 mb-1">
              ...
              <span>by ASIM DEVELOPER</span>
            </div>
            <p className="text-xs">AI Homework Helper • Powered by Gemini Flash</p>
          </motion.div>
        </motion.footer>
      </div>
    </div>
